...
public class NFLv3AdvancedMetricsClient extends BaseClient {
  public NFLv3AdvancedMetricsClient(String apiKey) {
    super(apiKey);
  }

  public NFLv3AdvancedMetricsClient(UUID apiKey) {
    super(apiKey);
  }
   ...
   *     default is regular season. Examples: <code>2018REG</code>, <code>2018PRE</code>, <code>
   *     2018POST</code>.
   * @param playerId Each NFL player has a unique ID assigned by FantasyData. Player IDs can be
   *     determined by pulling player related data. Example:<code>732</code>
